...
const WIDGET_REGISTRY = [
  ...
  },
  {
    ...
    label: 'Ring',
    icon: '🔔',
    component: RingWidget,
    category: 'smart-home',
    description: 'Ring doorbell and camera feed. View devices, battery status, motion events, and doorbell activity. Supports 2FA login.',
    requires: ['ringToken'],
    requiresLabel: 'Ring account (login with email/password + 2FA)',
    status: 'stable',
  },
];
