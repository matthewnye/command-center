...
const TZ_DATABASE = [
  // Americas
  { label: 'Anchorage', tz: 'America/Anchorage', lat: 61.2, lng: -149.9, region: 'Americas' },
  { label: 'Honolulu', tz: 'Pacific/Honolulu', lat: 21.3, lng: -157.8, region: 'Americas' },
  { label: 'Portland', tz: 'America/Los_Angeles', lat: 45.5, lng: -122.7, region: 'Americas' },
  { label: 'Seattle', tz: 'America/Los_Angeles', lat: 47.6, lng: -122.3, region: 'Americas' },
  { label: 'San Francisco', tz: 'America/Los_Angeles', lat: 37.8, lng: -122.4, region: 'Americas' },
  { label: 'Los Angeles', tz: 'America/Los_Angeles', lat: 34, lng: -118.2, region: 'Americas' },
  { label: 'Flagstaff', tz: 'America/Phoenix', lat: 35.2, lng: -111.6, region: 'Americas' },
  { label: 'Phoenix', tz: 'America/Phoenix', lat: 33.4, lng: -112, region: 'Americas' },
  { label: 'Denver', tz: 'America/Denver', lat: 39.7, lng: -105, region: 'Americas' },
  { label: 'Salt Lake City', tz: 'America/Denver', lat: 40.8, lng: -111.9, region: 'Americas' },
  { label: 'Dallas', tz: 'America/Chicago', lat: 32.8, lng: -96.8, region: 'Americas' },
  { label: 'Chicago', tz: 'America/Chicago', lat: 41.9, lng: -87.6, region: 'Americas' },
  { label: 'Nashville', tz: 'America/Chicago', lat: 36.2, lng: -86.8, region: 'Americas' },
  { label: 'Houston', tz: 'America/Chicago', lat: 29.8, lng: -95.4, region: 'Americas' },
  { label: 'Minneapolis', tz: 'America/Chicago', lat: 44.9, lng: -93.3, region: 'Americas' },
  { label: 'New Orleans', tz: 'America/Chicago', lat: 30, lng: -90.1, region: 'Americas' },
  { label: 'New York', tz: 'America/New_York', lat: 40.7, lng: -74, region: 'Americas' },
  { label: 'Boston', tz: 'America/New_York', lat: 42.4, lng: -71.1, region: 'Americas' },
  { label: 'Washington DC', tz: 'America/New_York', lat: 38.9, lng: -77, region: 'Americas' },
  { label: 'Miami', tz: 'America/New_York', lat: 25.8, lng: -80.2, region: 'Americas' },
  { label: 'Orlando', tz: 'America/New_York', lat: 28.5, lng: -81.4, region: 'Americas' },
  { label: 'Atlanta', tz: 'America/New_York', lat: 33.7, lng: -84.4, region: 'Americas' },
  { label: 'Detroit', tz: 'America/New_York', lat: 42.3, lng: -83, region: 'Americas' },
  { label: 'Buffalo', tz: 'America/New_York', lat: 42.9, lng: -78.9, region: 'Americas' },
  { label: 'Toronto', tz: 'America/Toronto', lat: 43.7, lng: -79.4, region: 'Americas' },
  { label: 'Montreal', tz: 'America/Toronto', lat: 45.5, lng: -73.6, region: 'Americas' },
  { label: 'Vancouver', tz: 'America/Vancouver', lat: 49.3, lng: -123.1, region: 'Americas' },
  { label: 'Mexico City', tz: 'America/Mexico_City', lat: 19.4, lng: -99.1, region: 'Americas' },
  { label: 'Bogotá', tz: 'America/Bogota', lat: 4.7, lng: -74.1, region: 'Americas' },
  { label: 'Lima', tz: 'America/Lima', lat: -12, lng: -77, region: 'Americas' },
  { label: 'São Paulo', tz: 'America/Sao_Paulo', lat: -23.5, lng: -46.6, region: 'Americas' },
  { label: 'Buenos Aires', tz: 'America/Argentina/Buenos_Aires', lat: -34.6, lng: -58.4, region: 'Americas' },
  { label: 'Santiago', tz: 'America/Santiago', lat: -33.4, lng: -70.6, region: 'Americas' },
  // Europe
  { label: 'Reykjavik', tz: 'Atlantic/Reykjavik', lat: 64.1, lng: -21.9, region: 'Europe' },
  { label: 'Dublin', tz: 'Europe/Dublin', lat: 53.3, lng: -6.3, region: 'Europe' },
  { label: 'London', tz: 'Europe/London', lat: 51.5, lng: -0.1, region: 'Europe' },
  { label: 'Edinburgh', tz: 'Europe/London', lat: 55.9, lng: -3.2, region: 'Europe' },
  { label: 'Belfast', tz: 'Europe/London', lat: 54.6, lng: -5.9, region: 'Europe' },
  { label: 'Lisbon', tz: 'Europe/Lisbon', lat: 38.7, lng: -9.1, region: 'Europe' },
  { label: 'Paris', tz: 'Europe/Paris', lat: 48.9, lng: 2.3, region: 'Europe' },
  { label: 'Brussels', tz: 'Europe/Brussels', lat: 50.8, lng: 4.4, region: 'Europe' },
  ...
  { label: 'Barcelona', tz: 'Europe/Madrid', lat: 41.4, lng: 2.2, region: 'Europe' },
  { label: 'Rome', tz: 'Europe/Rome', lat: 41.9, lng: 12.5, region: 'Europe' },
  { label: 'Milan', tz: 'Europe/Rome', lat: 45.5, lng: 9.2, region: 'Europe' },
  { label: 'Zurich', tz: 'Europe/Zurich', lat: 47.4, lng: 8.5, region: 'Europe' },
  { label: 'Berlin', tz: 'Europe/Berlin', lat: 52.5, lng: 13.4, region: 'Europe' },
  { label: 'Munich', tz: 'Europe/Berlin', lat: 48.1, lng: 11.6, region: 'Europe' },
  { label: 'Vienna', tz: 'Europe/Vienna', lat: 48.2, lng: 16.4, region: 'Europe' },
  { label: 'Prague', tz: 'Europe/Prague', lat: 50.1, lng: 14.4, region: 'Europe' },
  { label: 'Warsaw', tz: 'Europe/Warsaw', lat: 52.2, lng: 21, region: 'Europe' },
  { label: 'Stockholm', tz: 'Europe/Stockholm', lat: 59.3, lng: 18.1, region: 'Europe' },
  { label: 'Oslo', tz: 'Europe/Oslo', lat: 59.9, lng: 10.7, region: 'Europe' },
  { label: 'Copenhagen', tz: 'Europe/Copenhagen', lat: 55.7, lng: 12.6, region: 'Europe' },
  { label: 'Helsinki', tz: 'Europe/Helsinki', lat: 60.2, lng: 24.9, region: 'Europe' },
  { label: 'Tallinn', tz: 'Europe/Tallinn', lat: 59.4, lng: 24.7, region: 'Europe' },
  { label: 'Riga', tz: 'Europe/Riga', lat: 56.9, lng: 24.1, region: 'Europe' },
  { label: 'Athens', tz: 'Europe/Athens', lat: 37.9, lng: 23.7, region: 'Europe' },
  { label: 'Bucharest', tz: 'Europe/Bucharest', lat: 44.4, lng: 26.1, region: 'Europe' },
  { label: 'Istanbul', tz: 'Europe/Istanbul', lat: 41, lng: 29, region: 'Europe' },
  { label: 'Kyiv', tz: 'Europe/Kyiv', lat: 50.5, lng: 30.5, region: 'Europe' },
  { label: 'Kryvyi Rih', tz: 'Europe/Kyiv', lat: 47.9, lng: 33.4, region: 'Europe' },
  { label: 'Moscow', tz: 'Europe/Moscow', lat: 55.8, lng: 37.6, region: 'Europe' },
  { label: 'St Petersburg', tz: 'Europe/Moscow', lat: 59.9, lng: 30.3, region: 'Europe' },
  // Middle East
  { label: 'Tel Aviv', tz: 'Asia/Jerusalem', lat: 32.1, lng: 34.8, region: 'Middle East' },
  { label: 'Dubai', tz: 'Asia/Dubai', lat: 25.2, lng: 55.3, region: 'Middle East' },
  { label: 'Riyadh', tz: 'Asia/Riyadh', lat: 24.7, lng: 46.7, region: 'Middle East' },
  { label: 'Doha', tz: 'Asia/Qatar', lat: 25.3, lng: 51.5, region: 'Middle East' },
  // Asia
  { label: 'Mumbai', tz: 'Asia/Kolkata', lat: 19.1, lng: 72.9, region: 'Asia' },
  { label: 'Delhi', tz: 'Asia/Kolkata', lat: 28.6, lng: 77.2, region: 'Asia' },
  { label: 'Bangalore', tz: 'Asia/Kolkata', lat: 12.9, lng: 77.6, region: 'Asia' },
  { label: 'Dhaka', tz: 'Asia/Dhaka', lat: 23.8, lng: 90.4, region: 'Asia' },
  { label: 'Bangkok', tz: 'Asia/Bangkok', lat: 13.8, lng: 100.5, region: 'Asia' },
  { label: 'Ho Chi Minh', tz: 'Asia/Ho_Chi_Minh', lat: 10.8, lng: 106.7, region: 'Asia' },
  { label: 'Singapore', tz: 'Asia/Singapore', lat: 1.3, lng: 103.8, region: 'Asia' },
  { label: 'Kuala Lumpur', tz: 'Asia/Kuala_Lumpur', lat: 3.1, lng: 101.7, region: 'Asia' },
  { label: 'Jakarta', tz: 'Asia/Jakarta', lat: -6.2, lng: 106.8, region: 'Asia' },
  ...
  { label: 'Beijing', tz: 'Asia/Shanghai', lat: 39.9, lng: 116.4, region: 'Asia' },
  { label: 'Taipei', tz: 'Asia/Taipei', lat: 25, lng: 121.5, region: 'Asia' },
  { label: 'Tokyo', tz: 'Asia/Tokyo', lat: 35.7, lng: 139.7, region: 'Asia' },
  { label: 'Seoul', tz: 'Asia/Seoul', lat: 37.6, lng: 127, region: 'Asia' },
  // Oceania
  { label: 'Perth', tz: 'Australia/Perth', lat: -31.9, lng: 115.9, region: 'Oceania' },
  { label: 'Sydney', tz: 'Australia/Sydney', lat: -33.9, lng: 151.2, region: 'Oceania' },
  { label: 'Melbourne', tz: 'Australia/Melbourne', lat: -37.8, lng: 145, region: 'Oceania' },
  { label: 'Brisbane', tz: 'Australia/Brisbane', lat: -27.5, lng: 153, region: 'Oceania' },
  { label: 'Auckland', tz: 'Pacific/Auckland', lat: -36.8, lng: 174.8, region: 'Oceania' },
  // Africa
  { label: 'Casablanca', tz: 'Africa/Casablanca', lat: 33.6, lng: -7.6, region: 'Africa' },
  { label: 'Lagos', tz: 'Africa/Lagos', lat: 6.5, lng: 3.4, region: 'Africa' },
  { label: 'Nairobi', tz: 'Africa/Nairobi', lat: -1.3, lng: 36.8, region: 'Africa' },
  ...
  { label: 'Cape Town', tz: 'Africa/Johannesburg', lat: -33.9, lng: 18.4, region: 'Africa' },
];
